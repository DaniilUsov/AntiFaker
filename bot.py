...
bot = Bot(token="5170860866:AAHv5ULqS1us7ne7o08MFHsyJjH20JPi9KM")
# Диспетчер для бота
dp = Dispatcher(bot)
...
async def cmd_start(message: types.Message):
    ...
    await message.answer("Добро пожаловать! Я бот для проверки новостей на фейки. Просто отправте мне сообщение")
